...
data_root = '../datasets-Error_Analysis_retriever_vs_others/Train'
test_root = '../datasets-Error_Analysis_retriever_vs_others/Test'

model_out = 'best_model_retriever_vs_other.pt'
pred_log = 'test_predictions_retriever_vs_other.txt'
cm_img = 'confusion_matrix_retriever_vs_other.png'
