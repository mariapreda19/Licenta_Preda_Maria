...
data_root = '../datasets-Error_Analysis_2classes/Train'
test_root = '../datasets-Error_Analysis_2classes/Test'

model_out = 'best_model_retriever.pt'
pred_log = 'test_predictions_retriever.txt'
cm_img = 'confusion_matrix_retriever.png'
