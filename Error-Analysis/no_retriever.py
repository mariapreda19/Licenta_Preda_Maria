...
data_root = '../datasets-Error_Analysis_no_retriever/Train'
test_root = '../datasets-Error_Analysis_no_retriever/Test'

model_out = 'best_model_no_retriever.pt'
pred_log = 'test_predictions_no_retriever.txt'
cm_img = 'confusion_matrix_no_retriever.png'
